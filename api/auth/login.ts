...
// POST /api/auth/login
// ---------------------------------------------------------------------------
// Phone-only, passwordless login. Accepts any phone format; normalises to
// E.164. Requires USE_DEV_AUTH=true.
//
// Response: { token: string, isNewUser: boolean, user: OwnProfile }
// ---------------------------------------------------------------------------
...
export default async function handler(
  ...
  try {
    ...
    logger.error("POST /api/auth/login failed", { message });
