  ...
  return (
    <div className="relative w-full h-[100dvh] snap-always bg-black flex flex-col overflow-hidden">
      ...
      <div className="absolute right-3 bottom-36 z-20 flex flex-col items-center gap-5">
        ...
        >
          <div className="w-12 h-12 rounded-full bg-[#25D366]/15 backdrop-blur-md border border-[#25D366]/50 flex items-center justify-center text-[#25D366] shadow-[0_0_14px_rgba(37,211,102,0.35)]">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="#25D366" className="drop-shadow-[0_0_6px_rgba(37,211,102,0.7)]">
