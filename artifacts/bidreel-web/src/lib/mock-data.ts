export interface User {
  ...
  avatar: string;
  handle: string;
  phone: string; // E.164 without + — used for wa.me links
}
...
export const mockAuctions: Auction[] = [
  ...
  },
  {
    ...
    description: "Deadstock, never worn. Authenticated by GOAT. Includes original box and extra laces. One of the most sought-after sneakers ever made.",
    currentBid: 1800,
    startingBid: 1000,
    endsAt: future(24),
  ...
  },
  {
    ...
    description: "RTX 4090, i9-13900K, 64GB DDR5, custom loop water cooling. Built in a modded Lian-Li case with reactive neon lighting. Benchmarks available.",
    currentBid: 4200,
    startingBid: 3000,
    endsAt: future(48),
  ...
  },
  {
    ...
    description: "Authenticated screen print. COA included. Framed, museum quality glass. Perfect for collectors.",
    currentBid: 6800,
    startingBid: 5000,
    endsAt: future(36),
  ...
  },
  {
    ...
    description: "All-original sunburst finish. Plays beautifully. Comes with original hardshell case. Recently set up by a professional luthier.",
    currentBid: 9200,
    startingBid: 7000,
    endsAt: future(60),
