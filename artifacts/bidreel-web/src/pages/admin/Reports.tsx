          ...
          {FILTER_TABS.map(tab => (
            ...
            >
              ...
              <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-bold ${
                statusFilter === tab.key ? "bg-violet-500/30 text-violet-300" : "bg-gray-700 text-gray-400"
              }`}>
                {counts[tab.key]}
              </span>
            </button>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-gray-500">
          ...
          <p className="text-sm" dir="rtl">
            {reports.length === 0 ? "لا توجد بلاغات بعد" : "لا توجد بلاغات تطابق هذه الفلترة"}
          </p>
        </div>
      ) : (
                ...
                return (
                  <tr key={r.id} className="hover:bg-gray-800/50 transition-colors" dir="rtl">
                    <td className="px-5 py-3.5">
                      <div className="font-medium text-white" dir="rtl">
                    ...
                    <td className="px-4 py-3.5 text-gray-300 text-xs max-w-[160px] truncate" dir="rtl">
                      {r.auction?.title ?? "—"}
                    </td>
