...
import { Settings, Grid, Gavel, LogOut } from "lucide-react";
...
export default function Profile() {
  ...
  const tabs: { id: Tab; label: string; icon: typeof Grid; count: number }[] = [
        ...
        <div className="relative px-5 pt-14 pb-6 overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-3 relative z-10">
            {[
              ...
              <div
                key={stat.label}
                className="bg-white/5 border border-white/8 rounded-2xl py-3 text-center"
              >
            ...
            {tabs.map(tab => {
              ...
              return (
                ...
                >
                  ...
                  <span className={isActive ? "text-white relative z-10" : "text-white/35 relative z-10"}>
                    {tab.label}
                  </span>
                  {tab.count > 0 && (
            ...
            myListings.length > 0 ? (
              ...
              <div className="py-16 text-center">
                ...
                <button
                  ...
                  className="mt-4 px-6 py-3 rounded-xl bg-primary text-white text-sm font-bold"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {myBid && (
                        <p className="text-xs text-muted-foreground">
                          Your bid: <span className="text-white">{formatCurrency(myBid.amount)}</span>
                        </p>
                      )}
                      <div className="flex items-center gap-2 mt-1.5">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          isLeading ? "bg-emerald-500/15 text-emerald-400" : "bg-red-500/15 text-red-400"
                        }`}>
